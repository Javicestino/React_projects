...
function Formulario({ pacientes, setPacientes, paciente }) {
  ...
  /*
  useEffect(() => {   // Escuchar los cambios que sucedan o esperar a que un componente este listo
    ...
    <div className="w-1/2 lg:w-2/5 mx-5">
      ...
      <form
       ...
       >
          ...
          <input 
            type="submit"
            className="bg-indigo-600 w-full p-3 text-white uppercase font-bold rounded-sm hover:bg-indigo-700
